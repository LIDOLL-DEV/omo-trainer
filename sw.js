const CACHE = `little-log-v101-little-log-brand-${self.registration.scope}`; // Install the fullscreen viewer with the app; private API responses are never cached.
