const CACHE = `little-log-v106-full-time-badge-${self.registration.scope}`; // Install the fullscreen viewer with the app; private API responses are never cached.
...
SHELL.push('./lib/record-sharing.js','./lib/badge-settings.js','./lib/message-badge.js','./lib/social-access.js'); // Opt-in controls remain in the shell while account preferences require a live connection.
