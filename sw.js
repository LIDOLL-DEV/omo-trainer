const CACHE = `little-log-v102-social-messaging-last-${self.registration.scope}`; // Install the fullscreen viewer with the app; private API responses are never cached.
