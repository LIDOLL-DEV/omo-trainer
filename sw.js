const CACHE = `little-log-v104-record-post-lines-${self.registration.scope}`; // Install the fullscreen viewer with the app; private API responses are never cached.
