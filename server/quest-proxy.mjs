export async function questProxy(secret,route,query,input){
 ...
 const url=new URL(route,base);for(const k of ['character_id','target','controller','revision','part','history','view','bank_page'])if(query?.has(k))url.searchParams.set(k,query.get(k));
